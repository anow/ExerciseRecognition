function [rTest rTrain] = howMuchTimeNeededForLowerLimbExercises(newData1, rowNum)
% function return results for recognizing all lower limb exercises starting from Position 0 for a given row number
...
%% recognize hip abduction/adduction
...
%% distinguish between hip flexion and knee flexion
